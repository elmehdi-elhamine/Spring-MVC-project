...
//....................... Page d'accueil - infos du cycle departm filiere .......................
	...
	public String FiliereEtudiants(@PathVariable Long id_etud, Model model) {
		Etudiant filiereEtudiants = etudiantRepository.findById(id_etud).get();
...
//..................... Liste des modules avec le nom du prof et semestre ..........................
	...
	public String ListeModules(@PathVariable Long id_etud, Model model) {
		List<Liste_modules> listeModules = listeModulesRepository.findByIdEtud(id_etud);
...
//..................... Liste des cours selon les modules ..........................
	  ...
	  List<Cours> listeCours = coursRepository.findCours(id_etud , nom_module);
...
//................................Liste des infos personnelles ...................................
	...
	public String ListeEtudiants(@PathVariable Long id_etud,Model model) {
		Etudiant listeEtudiants = etudiantRepository.findById(id_etud).get();
...
//...........................Liste des reclamations recues de profs ...................................
		...
		public String ListeReclamsProf(@PathVariable Long id_etud,Model model) {
			List<ReclamationProf> listeReclamProf = reclam_ProfRepository.findReclamProf(id_etud);
...
//........................... Les reclamation envoyées par l'etudiant ...............................
	 ...
	 public String ListeRclmE(@PathVariable Long id_etud , Model model) {
	     List<ReclamationEtudiant> listReclamationsE = reclam_EtudRepository.listRclmEtud(id_etud);
	 ...
	 public String showNewReclamEtudPage(@PathVariable Long id_etud  ,Model model) {
    	 
    	 List<Professeur> listeProfs = profRepository.findAll();
    	 
		 ReclamationEtudiant reclamationsE = new ReclamationEtudiant();
		 Etudiant ee =etudiantRepository.findById(id_etud).get();
	 ...
	 public String saveReclamationE(@ModelAttribute("reclamationsE") ReclamationEtudiant reclamationsE) {
